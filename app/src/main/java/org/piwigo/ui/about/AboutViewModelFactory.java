...
public class AboutViewModelFactory implements ViewModelProvider.Factory {
    ...
    @Inject public AboutViewModelFactory(Context context) {
        this.context = context;
    }

    @Override public <T extends ViewModel> T create(Class<T> viewModelClass) {
        if (viewModelClass.isAssignableFrom(AboutViewModel.class)) {
            //noinspection unchecked
            return (T) new AboutViewModel(context.getResources());
        }
